...
def EMG_control_single_th(root_dir, N_Subj_arr, N_block_arr, low_f, high_f, t_min, t_max, window_len, window_step,
                          std_times, t_min_baseline, t_max_baseline, tag_events=False, verbose=False):
    """
    Parameters
    ----------
    root_dir : str

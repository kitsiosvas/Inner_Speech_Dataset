...
def Event_correction(N_S, N_E, events):
    ...
    for i in range(len(Events_code)):
        ...
        if Events_code[i, 0] == 42:
            ...
            if (Events_code[i + 1, 0] == 31 or Events_code[i + 1, 0] == 32 or Events_code[i + 1, 0] == 33 or
                    Events_code[i + 1, 0] == 34):
                # Do nothing
                pass
            # If the next mark is the mark for concentration the tag is missing
            elif Events_code[i + 1, 0] == 44:
                min_tag = min(Event_count[Event_count[:, 0] == 31, 1], Event_count[Event_count[:, 0] == 32, 1],
                              Event_count[Event_count[:, 0] == 33, 1], Event_count[Event_count[:, 0] == 34, 1])
        ...
        if Events_code[i, 0] == 46:
            if (Events_code[i + 1, 0] == 42 or Events_code[i + 1, 0] == 16 or Events_code[i + 1, 0] == 17):
                pass
            elif (Events_code[i + 1, 0] == 61 or Events_code[i + 1, 0] == 62 or Events_code[i + 1, 0] == 63 or
                  Events_code[i + 1, 0] == 64):
        ...
        if Events_code[i, 0] == 17:
            if (Events_code[i + 1, 0] == 61 or Events_code[i + 1, 0] == 62 or Events_code[i + 1, 0] == 63 or
                    Events_code[i + 1, 0] == 64):
                pass
            else:
    ...
    if Warnings == 0:
        ...
        for i in range(len(Events_code_fix)):
            ...
            if Events_code_fix[i, 0] == 46:
                if (Events_code_fix[i + 1, 0] == 42 or Events_code_fix[i + 1, 0] == 16 or Events_code_fix[
                    i + 1, 0] == 17):
                    pass
                else:
                    print('Warning, miss start at i = ' + str(i))
            ...
            if (Events_code_fix[i, 0] == 61 or Events_code_fix[i, 0] == 62 or Events_code_fix[i, 0] == 63 or
                    Events_code_fix[i, 0] == 64):
            ...
            if (Events_code_fix[i, 0] == 31 or Events_code_fix[i, 0] == 32 or Events_code_fix[i, 0] == 33 or
                    Events_code_fix[i, 0] == 34):
            ...
            if Events_code_fix[i, 0] == 17:
                if (Events_code_fix[i + 1, 0] == 61 or Events_code_fix[i + 1, 0] == 62 or Events_code_fix[
                    i + 1, 0] == 63 or Events_code_fix[i + 1, 0] == 64):
                    pass
                else:
                    print('Warning, miss Answerd at i = ' + str(i))
                    Warnings = Warnings + 1
    ...
    if (Event_count_fix[Event_count_fix[:, 0] == 11, 1] == 1 and Event_count_fix[
        Event_count_fix[:, 0] == 12, 1] == 1 and Event_count_fix[Event_count_fix[:, 0] == 13, 1] == 1 and
            Event_count_fix[Event_count_fix[:, 0] == 14, 1] == 1):
        print('Start OK')
    else:
        raise Exception("Missing Stars")

    # Check if blocks are OK
    if Event_count_fix[Event_count_fix[:, 0] == 15, 1] == Event_count_fix[Event_count_fix[:, 0] == 16, 1] == \
            Event_count_fix[Event_count_fix[:, 0] == 51, 1] + 1:
        print('Blocks OK')
    else:
        raise Exception("Missing Blocks")

    # Check if Tags OK
    if Event_count_fix[Event_count_fix[:, 0] == 31, 1] == Event_count_fix[Event_count_fix[:, 0] == 32, 1] == \
            Event_count_fix[Event_count_fix[:, 0] == 33, 1] == Event_count_fix[Event_count_fix[:, 0] == 34, 1]:
        print('Tags OK')
    else:
        raise Exception("Missing Tags")

    # Check if Marks OK
    if Event_count_fix[Event_count_fix[:, 0] == 42, 1] == Event_count_fix[Event_count_fix[:, 0] == 44, 1] == \
            Event_count_fix[Event_count_fix[:, 0] == 45, 1] == Event_count_fix[Event_count_fix[:, 0] == 46, 1]:
        print('Marks OK')
    else:
...
def Cognitive_control_check(events):
    ...
    if Event_count[Event_count[:, 0] == 17, 1] == Ans_R + Ans_W:
        if Event_count[Event_count[:, 0] == 17, 1] == Ans_R:
            ...
            print(
                'Warning, ' + str(Ans_W) + ' of ' + str(Event_count[Event_count[:, 0] == 17, 1]) + ' Answers are wrong')
    else:
        raise Exception("Missing Congnitive Control Question/Answer")
